...
- The user asks to write, improve, or debug a prompt
- Building system prompts, few-shot templates, or structured-output schemas
- Designing prompts for code generation, classification, extraction, or tool use
- Reviewing prompts for vagueness, contradictions, or injection risk

## Instructions

1. Clarify the goal, audience, and success criteria for the prompt.
2. Apply the core principles and techniques below.
3. Prefer short, precise prompts with 1–2 examples over long instruction dumps.
4. Deliver a ready-to-use prompt (and optional variants) plus brief notes on temperature and edge cases to test.
